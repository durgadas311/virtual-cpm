...
public class I8085Disassembler implements Z80Disassembler {
	Memory mem;
	boolean rom;
	int bnk;
	int lastLen;

	public I8085Disassembler(Memory mem) {
		this.mem = mem;
	}
	...
	public String disas(boolean rom, int bnk, int pc) {
		...
		if ((opCode & 0xc0) == 0x40) {
			...
			case 0xDC:       /* CALL C,nn */
				...
				break;
			case 0xDD:
				instr = String.format("jnk %04x", read16(pc));
				break;
			case 0xDE:       /* SBC A,n */
			...
			case 0xFC:       /* CALL M,nn */
				...
				break;
			case 0xFD:
				instr = String.format("jk %04x", read16(pc));
				break;
			case 0xFE:       /* CP n */
